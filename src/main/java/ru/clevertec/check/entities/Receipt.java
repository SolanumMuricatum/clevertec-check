...
public class Receipt implements BasicReceipt {
    ...
    public Receipt(List<Product> products, int discountCard, double balanceDebitCard, int discountPercentage, double totalPrice, double totalDiscount, double totalPriceWithDiscount, String date, String time) {
